...
$sql = "INSERT INTO admission (fullname,sex,phone,email,lga,state,jamb_number,jamb_score,faculty,dept,ssce_details,ssce,status,photo,date_admission,applicationID)VALUES( '$fullname','$sex','$phone','$email','$lga','Kano','$jambno','$jambscore','$faculty','$dept','$exam','$credential','$status','$photo','$current_date','$applicationID')";
			...
			<div class="form-group">
			 ...
			 <div class="form-group">
              <label class="col-lg-12 control-label" for="pass1">LGA:
                ...
                <select id="pass1" class="form-control" name="txtlga" required="">
